...
TEST(trabalho2_test, deve_ser_capaz_de_resolver_sistema)
{
    ...
    //     TSistema s(A, b);
    //     EXPECT_TRUE(s.Resolve(TSistema::EMetodo::GAUSS_JACOBI, 0.05).Igual(xEsperado, tol));
    //     EXPECT_TRUE(s.Resolve(TSistema::EMetodo::GAUSS_SEIDEL, 0.05).Igual(xEsperado, tol));
    // }
    // {
    ...
    // }
    {
        ...
        TSistema s(A, b);
        EXPECT_TRUE(s.Resolve(TSistema::EMetodo::GAUSS_JACOBI, 0.01).Igual(xEsperado, tol));
        EXPECT_TRUE(s.Resolve(TSistema::EMetodo::GAUSS_SEIDEL, 0.01).Igual(xEsperado, tol));
    }
}
